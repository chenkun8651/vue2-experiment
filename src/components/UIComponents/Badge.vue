      ...
      <a-card class="card-margin" title="AntDesignVue 徽标数">
        <div class="radio-box">
          <a-radio-group v-model="badgeDot" @change="changeDot">
            <a-radio-button :value="null">显示数字</a-radio-button>
            <a-radio-button :value="false">显示圆点</a-radio-button>
          </a-radio-group>
          <div class="string-set">
            <span style="margin-right: 5px">设置徽标文本</span>
          ...
          <a-radio-group v-show="badgeDot === null" v-model="badgeShowZero">
      ...
      <a-card class="card-margin" title="ElementUI 徽标数">
        <div class="radio-box">
          <a-radio-group v-model="badgeIsDotE">
            <a-radio-button :value="false">显示数字</a-radio-button>
            <a-radio-button :value="true">显示圆点</a-radio-button>
          </a-radio-group>
          <a-radio-group v-model="badgeTypeE">
            <a-radio-button :value="'success'">成功</a-radio-button>
            <a-radio-button :value="'primary'">默认</a-radio-button>
            <a-radio-button :value="'info'">信息</a-radio-button>
            <a-radio-button :value="'danger'">错误</a-radio-button>
            <a-radio-button :value="'warning'">警告</a-radio-button>
          </a-radio-group>
      ...
      <a-card class="card-margin" title="AtUI 徽标数">
        ...
        <div>
          <at-badge
            ...
            :show="badgeShowA"
            :value="badgeValueA"
            :max-num="badgeMaxNumA"
          >
            <at-button>评论</at-button>
          </at-badge>
        </div>
      </a-card>
      <!-- ViewUI -->
      <a-card class="card-margin" title="ViewUI 徽标数">
        <div class="radio-box">
          <a-radio-group v-model="badgeDotV" @change="changeDotV">
            <a-radio-button :value="false">显示数字</a-radio-button>
            <a-radio-button :value="null">显示圆点</a-radio-button>
          </a-radio-group>
          <a-radio-group v-show="badgeDotV !== null" v-model="badgeTypeV">
            <a-radio-button :value="'success'">成功数字</a-radio-button>
            <a-radio-button :value="'primary'">默认数字</a-radio-button>
            <a-radio-button :value="'normal'">普通数字</a-radio-button>
            <a-radio-button :value="'error'">错误数字</a-radio-button>
            <a-radio-button :value="'warning'">警告数字</a-radio-button>
            <a-radio-button :value="'info'">信息数字</a-radio-button>
          </a-radio-group>
          ...
          <div v-show="badgeDotV !== null" class="number-set">
            ...
            <a-input-number
              style="width: 100px"
              v-model="badgeOverflowCountV"
            />
          </div>
          <a-radio-group v-show="badgeDotV === null" v-model="badgeStatusV">
            <a-radio-button :value="'success'">成功状态</a-radio-button>
            <a-radio-button :value="'processing'">处理中状态</a-radio-button>
            <a-radio-button :value="'default'">默认状态</a-radio-button>
            <a-radio-button :value="'error'">错误状态</a-radio-button>
            <a-radio-button :value="'warning'">警告状态</a-radio-button>
          </a-radio-group>
        ...
        <div>
          <Badge
            ...
            :type="badgeTypeV"
            :status="badgeStatusV"
            :show-zero="badgeShowZeroV"
            :count="badgeCountV"
            :overflow-count="badgeOverflowCountV"
            :color="badgeColorV"
            :text="badgeTextV"
          >
            <Button>评论</Button>
...
export default {
  data() {
    return {
      ...
      badgeDotV: null,
      badgeTypeV: "normal",
      badgeStatusV: "default",
      badgeShowZeroV: true,
      badgeCountV: 1,
      badgeOverflowCountV: 99,
      badgeColorV: null,
      badgeTextV: "",
    };
  },
  methods: {
    ...
    changeDotV() {
      if (this.badgeDotV === null) {
        // 变成圆点徽标
        this.badgeDotV = null;
        this.badgeStatusV = "default";
      } else {
        // 变成数字徽标
        this.badgeDotV = false;
        this.badgeStatusV = null;
      }
    },
  },
};
